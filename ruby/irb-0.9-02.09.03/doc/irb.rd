...
For example, describe as follows in `.irbrc'. 
  ...
  IRB.conf[:PROMPT][:MY_PROMPT] = { # name of prompt mode
    ...
    :PROMPT_N => nil,		  # prompt for continuated statements
    :PROMPT_S => nil,		  # prompt for continuated strings
    :PROMPT_C => nil,		  # prompt for continuated expression
...
Constants PROMPT_I, PROMPT_N, PROMPT_S and PROMPT_C specifies the
format. In the prompt specification, some special strings are
available.
